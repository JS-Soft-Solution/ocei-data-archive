...
class SupervisorReportController extends Controller
{
    ...
    {
        return view('permits.supervisor.reports.index');
    }
    ...
    public function exportExcel(Request $request)
    {
        ...
        $fileName = 'supervisor_applications_' . now()->format('Y-m-d_His') . '.xlsx';

        return Excel::download(new SupervisorExport($filters), $fileName);
    }
    ...
    public function exportPdf(Request $request)
    {
        ...
        $pdf = Pdf::loadView('permits.supervisor.reports.pdf', compact('applications', 'filters'));

        $fileName = 'supervisor_applications_' . now()->format('Y-m-d_His') . '.pdf';
    ...
    public function preview(Request $request)
    {
        ...
        return view('permits.supervisor.reports.preview', compact('applications', 'filters'));
    }
