...
class ContractorSecretaryController extends Controller
{
    ...
    public function pending(Request $request)
    {
        ...
        return view('permits.contractor.secretary.pending', compact('applications'));
    }
    ...
    public function show(ExContractorRenewApplication $application)
    {
        ...
        return view('permits.contractor.secretary.show', compact('application'));
    }
