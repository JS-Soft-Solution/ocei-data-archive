            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Pending Approval - Electrician Applications</h4>
                        <p class="text-muted mb-0">Applications you have submitted and are awaiting review</p>
                    </div>

                    <div class="card-body">
                        {{-- Search Form --}}
                        <form method="GET" action="{{ route('ex-electrician.operator.pending') }}" class="mb-4">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a href="{{ route('ex-electrician.operator.pending') }}"
