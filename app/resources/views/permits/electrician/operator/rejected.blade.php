            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4><i class="fas fa-exclamation-triangle text-warning"></i> Rejected Applications - Electrician
                        </h4>
                    ...
                    <div class="card-body">
                        {{-- Search Form --}}
                        <form method="GET" action="{{ route('ex-electrician.operator.rejected') }}" class="mb-4">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a href="{{ route('ex-electrician.operator.rejected') }}"
