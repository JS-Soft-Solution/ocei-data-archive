                            ...
                            <tbody>
                                @forelse($applications as $app)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('ex-electrician.secretary.show', $app) }}"
    ...
    <div class="modal fade" id="bulkRejectModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="{{ route('ex-electrician.secretary.bulk-reject') }}">
                    @csrf
    ...
    @push('scripts')
        <script>
            ...
            function bulkApprove() {
                ...
                form.method = 'POST';
                form.action = '{{ route("ex-electrician.secretary.bulk-approve") }}';
