            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4>My Supervisor Applications</h4>
                        <div>
                            <a href="{{ route('ex-supervisor.operator.create') }}" class="btn btn-primary">
                    ...
                    <div class="card-body">
                        ...
                        <form method="GET" action="{{ route('ex-supervisor.operator.index') }}" class="mb-4">
                            <div class="row">
                                <div class="col-md-3">
                        ...
                        {{-- Bulk Actions --}}
                        <form id="bulkSubmitForm" method="POST" action="{{ route('ex-supervisor.operator.bulk-submit') }}">
                            @csrf
                            <div class="mb-3">
                ...
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('ex-supervisor.operator.claim') }}">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
    ...
    @push('scripts')
        <script>
            ...
            function submitApplication(appId) {
                ...
                form.method = 'POST';
                form.action = '/ex-supervisor/operator/' + appId + '/submit';
