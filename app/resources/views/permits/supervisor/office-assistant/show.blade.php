                ...
                <div class="card">
                    ...
                    <div class="card-body">
                                    ...
                                    @foreach($application->attachments as $attachment)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if(in_array(strtolower(pathinfo($attachment->path, PATHINFO_EXTENSION)), ['pdf', 'jpg', 'jpeg', 'png', 'webp']))
                        ...
                        <div class="mt-4 d-flex justify-content-between">
                            <a href="{{ route('ex-supervisor.office-assistant.pending') }}" class="btn btn-secondary">
                            ...
                            <div>
                                ...
                                <form method="POST"
                                    action="{{ route('ex-supervisor.office-assistant.approve', $application) }}"
                                    class="d-inline">
                                    @csrf
    ...
    <div class="modal fade" id="rejectModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="{{ route('ex-supervisor.office-assistant.reject', $application) }}">
                    @csrf
