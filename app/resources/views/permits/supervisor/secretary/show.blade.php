...
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-4 d-flex justify-content-between">
                            <a href="{{ route('ex-supervisor.secretary.pending') }}" class="btn btn-secondary">
    ...
    <div class="modal fade" id="approveModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="{{ route('ex-supervisor.secretary.approve', $application) }}">
                    @csrf
    ...
    <div class="modal fade" id="rejectModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="{{ route('ex-supervisor.secretary.reject', $application) }}">
                    @csrf
