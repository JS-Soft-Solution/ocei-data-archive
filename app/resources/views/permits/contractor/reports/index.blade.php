    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h4>Generate Report - Contractor Permits</h4>
            </div>
            <div class="card-body">
                <form method="GET" action="{{ route('ex-contractor.reports.preview') }}">
                    <div class="row">
                    ...
                    <div class="mt-4">
                        ...
                        <button type="submit" formaction="{{ route('ex-contractor.reports.export-excel') }}"
                            class="btn btn-success">
                            <i class="fas fa-file-excel"></i> Export to Excel
                        </button>
                        <button type="submit" formaction="{{ route('ex-contractor.reports.export-pdf') }}"
