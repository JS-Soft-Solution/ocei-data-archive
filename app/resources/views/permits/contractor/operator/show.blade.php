            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <div>
                            <h4>View Contractor Application - {{ $application->old_certificate_number }}</h4>
                        ...
                        <div>
                            @if($application->canBeEdited())
                                <a href="{{ route('ex-contractor.operator.edit', $application) }}" class="btn btn-primary">
                                    <i class="fas fa-edit"></i> Edit Application
                                </a>
                            @endif
                            <a href="{{ route('ex-contractor.operator.index') }}" class="btn btn-secondary">
