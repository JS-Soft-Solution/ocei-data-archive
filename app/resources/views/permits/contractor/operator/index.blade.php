            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4>My Contractor Applications</h4>
                        <div>
                            <a href="{{ route('ex-contractor.operator.create') }}" class="btn btn-primary">
                    ...
                    <div class="card-body">
                        ...
                        <form method="GET" action="{{ route('ex-contractor.operator.index') }}" class="mb-4">
                            <div class="row">
                                <div class="col-md-3">
                        ...
                        {{-- Bulk Actions --}}
                        <form id="bulkSubmitForm" method="POST" action="{{ route('ex-contractor.operator.bulk-submit') }}">
                            @csrf
                            <div class="mb-3">
                                    ...
                                    <tbody>
                                        @forelse($applications as $app)
                                            <tr>
                                                ...
                                                <td>
                                                    @if($app->canBeEdited())
                                                        <a href="{{ route('ex-contractor.operator.edit', $app) }}"
                                                    ...
                                                    <a href="{{ route('ex-contractor.operator.show', $app) }}"
                ...
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('ex-contractor.operator.claim') }}">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
    ...
    @push('scripts')
        <script>
            ...
            function submitApplication(appId) {
                ...
                form.method = 'POST';
                form.action = '/ex-contractor/operator/' + appId + '/submit';
