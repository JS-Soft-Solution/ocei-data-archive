            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4>Edit Contractor Application - {{ $application->old_certificate_number }}</h4>
                    ...
                    <div class="card-body">
                        @if(!$application->canBeEdited())
                            <div class="alert alert-warning">
                                ...
                                <a href="{{ route('ex-contractor.operator.index') }}"
                        ...
                        {{-- Main Form --}}
                        <form method="POST" action="{{ route('ex-contractor.operator.update', $application) }}"
                            id="applicationForm">
                            @csrf
                            @method('PUT')
                            ...
                            @if($application->canBeEdited())
                                <div class="mt-4 mb-3 d-flex justify-content-between">
                                    <div>
                                        @if(request('tab', 1) > 1)
                                            <a href="{{ route('ex-contractor.operator.edit', ['application' => $application, 'tab' => request('tab', 1) - 1]) }}"
        ...
        <script>
            ...
            document.querySelectorAll('#applicationTabs button').forEach((btn, index) => {
                btn.addEventListener('click', function (e) {
                    ...
                    window.location.href = '{{ route('ex-contractor.operator.edit', $application) }}?tab=' + tabNumber;
                });
            });
            ...
            if (saveNextBtn) {
                saveNextBtn.addEventListener('click', function () {
                    ...
                    form.action = '{{ route('ex-contractor.operator.save-tab', $application) }}';
                    form.submit();
                });
            }
            ...
            function submitApplicationFromEdit() {
                ...
                submitForm.action = '{{ route('ex-contractor.operator.submit', $application) }}';
