    ...
    {{-- <div class="d-flex align-items-center">--}}
        {{-- <div class="toggle-icon-wrapper">--}}
            ...
            {{-- <div class="d-flex align-items-center py-3"><img class="me-2" --}} {{--
                    src="{{ asset('assets/img/ocei-logo.png') }}" alt="" width="170" /><span--}} {{--
            ...
            {{-- <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">--}}
                ...
                {{-- <li class="nav-item">--}}
                    ...
                    {{-- <ul class="nav collapse" id="e-commerce">--}}
                        {{-- <li class="nav-item"><a class="nav-link dropdown-indicator" href="#product" --}} {{--
                            ...
                            {{-- <ul class="nav collapse" id="product">--}}
                                {{-- <li class="nav-item"><a class="nav-link"
                                        ...
                                        {{-- <div class="d-flex align-items-center"><span
                                                class="nav-link-text ps-1">Product--}}
                                                {{-- list</span></div>--}}
                                        {{-- </a><!-- more inner pages--></li>--}}
                                {{-- <li class="nav-item"><a class="nav-link"
                        ...
                        {{-- <li class="nav-item"><a class="nav-link" href="app/e-commerce/customer-details.html">--}}
                                {{-- <div class="d-flex align-items-center"><span
                                        class="nav-link-text ps-1">Customer--}}
                                        {{-- details</span></div>--}}
                                {{-- </a><!-- more inner pages--></li>--}}
                        ...
                        {{-- <li class="nav-item"><a class="nav-link dropdown-indicator" href="#course" --}} {{--
                            ...
                            {{-- <ul class="nav collapse" id="course">--}}
                                {{-- <li class="nav-item"><a class="nav-link"
                                        ...
                                        {{-- <div class="d-flex align-items-center"><span
                                                class="nav-link-text ps-1">Course--}}
                                                {{-- list</span></div>--}}
                                        {{-- </a><!-- more inner pages--></li>--}}
                                {{-- <li class="nav-item"><a class="nav-link"
                                ...
                                {{-- <li class="nav-item"><a class="nav-link"
                                        ...
                                        {{-- <div class="d-flex align-items-center"><span
                                                class="nav-link-text ps-1">Create a--}}
                                                {{-- course</span></div>--}}
                                        {{-- </a><!-- more inner pages--></li>--}}
                                {{-- </ul>--}}
                            {{-- </li>--}}
                ...
                {{-- <li class="nav-item">--}}
                        ...
                        {{-- <li class="nav-item"><a class="nav-link dropdown-indicator" href="#simple" --}} {{--
                            ...
                            {{-- <ul class="nav collapse" id="simple">--}}
                                ...
                                {{-- <li class="nav-item"><a class="nav-link" --}} {{--
                                        ...
                                        {{-- <div class="d-flex align-items-center"><span
                                                class="nav-link-text ps-1">Forgot--}}
                                                {{-- password</span></div>--}}
                                        {{-- </a><!-- more inner pages--></li>--}}
                                {{-- <li class="nav-item"><a class="nav-link"
                                ...
                                {{-- <li class="nav-item"><a class="nav-link" --}} {{--
                                        ...
                                        {{-- <div class="d-flex align-items-center"><span
                                                class="nav-link-text ps-1">Reset--}}
                                                {{-- password</span></div>--}}
                                        {{-- </a><!-- more inner pages--></li>--}}
                                {{-- <li class="nav-item"><a class="nav-link"
                                        href="pages/authentication/simple/lock-screen.html">--}}
                                        {{-- <div class="d-flex align-items-center"><span
                                                class="nav-link-text ps-1">Lock--}}
                                                {{-- screen</span></div>--}}
                                        {{-- </a><!-- more inner pages--></li>--}}
                                {{-- </ul>--}}
                            {{-- </li>--}}
                    ...
                    {{-- <ul class="nav collapse" id="user">--}}
                        ...
                        {{-- </ul>--}}
                    {{-- <!-- parent pages-->--}}
                    {{-- <a class="nav-link dropdown-indicator" href="#pricing" role="button" data-bs-toggle="collapse"
                    ...
                    {{-- <ul class="nav collapse" id="miscellaneous">--}}
                        ...
                        {{-- </ul>--}}
                    {{-- <!-- parent pages-->--}}
                    {{-- <a class="nav-link dropdown-indicator" href="#Layouts" role="button" data-bs-toggle="collapse"
                ...
                {{-- <li class="nav-item">--}}
                        ...
                        {{-- <li class="nav-item"><a class="nav-link dropdown-indicator" href="#basic"
                            ...
                            {{-- <ul class="nav collapse" id="basic">--}}
                                ...
                                {{-- <li class="nav-item"><a class="nav-link"
                                        ...
                                        {{-- <div class="d-flex align-items-center"><span
                                                class="nav-link-text ps-1">Input--}}
                                                {{-- group</span></div>--}}
                                        {{-- </a><!-- more inner pages--></li>--}}
                                {{-- <li class="nav-item"><a class="nav-link"
                        ...
                        {{-- <li class="nav-item"><a class="nav-link dropdown-indicator" href="#advance" --}} {{--
                            ...
                            {{-- <ul class="nav collapse" id="advance">--}}
                                ...
                                {{-- <li class="nav-item"><a class="nav-link"
                                        ...
                                        {{-- <div class="d-flex align-items-center"><span
                                                class="nav-link-text ps-1">Emoji--}}
                                                {{-- button</span></div>--}}
                                        {{-- </a><!-- more inner pages--></li>--}}
                                {{-- <li class="nav-item"><a class="nav-link"
                                        href="modules/forms/advance/file-uploader.html">--}}
                                        {{-- <div class="d-flex align-items-center"><span
                                                class="nav-link-text ps-1">File--}}
                                                {{-- uploader</span></div>--}}
                                        {{-- </a><!-- more inner pages--></li>--}}
                                {{-- <li class="nav-item"><a class="nav-link"
                                ...
                                {{-- <li class="nav-item"><a class="nav-link"
                                        ...
                                        {{-- <div class="d-flex align-items-center"><span
                                                class="nav-link-text ps-1">Range--}}
                                                {{-- slider</span></div>--}}
                                        {{-- </a><!-- more inner pages--></li>--}}
                                {{-- <li class="nav-item"><a class="nav-link"
                    ...
                    {{-- <ul class="nav collapse" id="tables">--}}
                        ...
                        {{-- </ul>--}}
                    {{-- <!-- parent pages-->--}}
                    {{-- <a class="nav-link dropdown-indicator" href="#charts" role="button" data-bs-toggle="collapse"
                    ...
                    {{-- <ul class="nav collapse" id="charts">--}}
                        ...
                        {{-- <li class="nav-item"><a class="nav-link dropdown-indicator" href="#eCharts" --}} {{--
                            ...
                            {{-- <ul class="nav collapse" id="eCharts">--}}
                                {{-- <li class="nav-item"><a class="nav-link"
                                        ...
                                        {{-- <div class="d-flex align-items-center"><span
                                                class="nav-link-text ps-1">Line--}}
                                                {{-- charts</span></div>--}}
                                        {{-- </a><!-- more inner pages--></li>--}}
                                {{-- <li class="nav-item"><a class="nav-link"
                                        href="modules/charts/echarts/bar-charts.html">--}}
                                        {{-- <div class="d-flex align-items-center"><span
                                                class="nav-link-text ps-1">Bar--}}
                                                {{-- charts</span></div>--}}
                                        {{-- </a><!-- more inner pages--></li>--}}
                                {{-- <li class="nav-item"><a class="nav-link" --}} {{--
                        ...
                        {{-- </ul>--}}
                    {{-- <!-- parent pages-->--}}
                    {{-- <a class="nav-link dropdown-indicator" href="#icons" role="button" data-bs-toggle="collapse"
                    ...
                    {{-- <ul class="nav collapse" id="icons">--}}
                        ...
                        {{-- </ul>--}}
                    {{-- <!-- parent pages-->--}}
                    {{-- <a class="nav-link dropdown-indicator" href="#maps" role="button" data-bs-toggle="collapse"
                ...
                @if(auth()->check())
                            ...
                            @if(auth()->user()->role === 'secretary')
                                <li class="nav-item">
                                    <a class="nav-link {{ request()->routeIs('ex-electrician.secretary.*') ? 'active' : '' }}"
                                        ...
                                        <div class="d-flex align-items-center">
                                            <span class="nav-link-text ps-1">Final Approval</span>
                                        </div>
                                    </a>
                                </li>
                            @endif
                            ...
                            @if(auth()->user()->role === 'chairman')
                                <li class="nav-item">
                                    <a class="nav-link {{ request()->routeIs('ex-electrician.chairman.*') ? 'active' : '' }}"
                                        ...
                                        <div class="d-flex align-items-center">
                                            <span class="nav-link-text ps-1">Approved Records</span>
                                        </div>
                                    </a>
                                </li>
                            @endif
                            ...
                            @if(auth()->user()->role === 'super_admin')
                                <li class="nav-item">
                                    <a class="nav-link {{ request()->routeIs('ex-electrician.admin.*') ? 'active' : '' }}"
                                        ...
                                        <div class="d-flex align-items-center">
                                            <span class="nav-link-text ps-1">Admin Override</span>
                                        </div>
                                    </a>
                                </li>
                            @endif
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav collapse {{ request()->is('ex-supervisor*') ? 'show' : '' }}" id="ex-supervisor">
                            ...
                            @endif
                            {{-- Add other roles when implemented --}}
                        </ul>
                    </li>

                    {{-- Ex-Contractor Module --}}
                    <li class="nav-item">
